...
public class ProductMasterVO implements Serializable {
	...
	public String toString() {
		return "ProductMasterVO [companyId=" + companyId + ", saleChannel=" + saleChannel + ", productName="
				+ productName + ", productGubuns=" + productGubuns + ", productKinds=" + productKinds
				+ ", productTypes=" + productTypes + ", napCycles=" + napCycles + ", insTerms=" + insTerms
				+ ", napTerms=" + napTerms + ", annuityAges=" + annuityAges + ", annuityTypes=" + annuityTypes
				+ ", assureMoneys=" + assureMoneys + ", minAssureMoney=" + minAssureMoney + ", maxAssureMoney="
				+ maxAssureMoney + ", productId=" + productId + "]";
	}
