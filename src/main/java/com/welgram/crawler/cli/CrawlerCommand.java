...
public class CrawlerCommand implements Callable<Integer> {
    ...
    @CommandLine.Option(names = {"-g", "--gender"}, description = "성별(A/M/F)", required = false, defaultValue = "A")
    String gender;
    ...
    @CommandLine.Option(names = {"-ss", "--screenShot"}, description = "스크린샷(Y/N)", required = false, defaultValue = "N")
    String screenShot;
