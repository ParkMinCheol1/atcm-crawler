...
public class SeleniumCrawlingHelper {
    ...
    protected final Duration WAIT_TIME = Duration.ofSeconds(30);
    ...
    public Optional<WebElement> findExistentElement(By by, Long... waitTime) {
        try {
            ...
            new WebDriverWait(driver, waitTime.length > 0 ? Duration.ofSeconds(waitTime[0]) : Duration.ofSeconds(0))
    ...
    public void waitForLoading(By... by) {
        ...
        WebDriverWait wait_10 = new WebDriverWait(driver, Duration.ofSeconds(10));
...
//            logger.info("####### 로딩 끝....");
    ...
    protected void clickByJavascriptExecutor(WebElement element, String... title) {
    ...
    public String sendKeys4_check(By by, String text, String... title) throws Exception { // done
        ...
        WebElement element = new WebDriverWait(driver, Duration.ofSeconds(5)).until(ExpectedConditions.presenceOfElementLocated(by)); // driver.findElement(by);
    ...
    public String selectByText_check(Select $select, String text, String... title) throws Exception { // done
        ...
        String selectedText = getSelectedText($select.getWrappedElement());
